...
tuition_data = data.frame(
  income = c(10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 110000, 120000, 130000, 140000),
  price = c(180, 360, 720, 1260, 1980, 2880, 3960, 5220, 6660, 8280, 10080, 12060, 14220, 16000),
  income_range = c('Under 10,000', '10,000 - 19,999', '20,000 - 29,999', '30,000 - 39,999', '40,000 - 49,999', '50,000 - 59,999', '60,000 - 69,999', '70,000 - 79,999', '80,000 - 89,999', '90,000 - 99,999', '100,000 - 109,999', '110,000 - 119,999', '120,000 - 129,999', '130,000+'))
